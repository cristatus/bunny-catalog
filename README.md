...
- **General-purpose CLI tools that show up in nearly every dev workflow.** ripgrep, fd, bat, fzf, jq, yq, gh, glab, lazygit, delta, difftastic, eza, zoxide, starship, atuin, zellij, broot, dust, duf, bottom, procs, sd, hyperfine, just, tealdeer, ShellCheck, shfmt, Lima.
